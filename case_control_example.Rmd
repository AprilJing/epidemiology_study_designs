...
# check to make sure matched df has no repeat controls
# !unique(matched_df$ID) # looks good
...
# mantel hanzel adjustment
# conditional odds ratio
discord_pairs <- matched_df %>% 
  group_by(match_id, Dis, Exp) %>% 
  summarise(n_group = n())
