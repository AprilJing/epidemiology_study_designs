...
As with any epidemiologic study, we have to deal with confounding. Let's simulate some confounding factors in to our study design.

```{r confounding, message=F}
