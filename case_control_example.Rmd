...
You can see from the above 2x2 table, that the proportion of exposure in controls (disease no), is roughly equivalent to our sample, where the controls had a proportion of exposure of 0.485, and in the sample population, those without the disease had a proportion of exposure of 0.495.
...
cc_odds_ratio <- c(odds_ratio, lower_bound, upper_bound)
cc_odds_ratio
```
